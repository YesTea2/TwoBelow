...
func _physics_process(delta):
	...
	if direction.x > 0:
		...
		if player_info.is_inside == false:
			handle_player_part(player_info.foot_step_side, player_info.time_foot_outdoor)
		if player_info.is_inside == true:
			handle_player_part(player_info.snow_footstep_side, player_info.time_foot_indoor)
		...
		if player_info.is_inside == false:
			handle_player_part(player_info.foot_step, player_info.time_foot_outdoor)
		if player_info.is_inside == true:
			handle_player_part(player_info.snow_footstep, player_info.time_foot_indoor)
